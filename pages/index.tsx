...
const Home: NextPage = ({ images, rudder }: { images: ImageProps[], rudder: any }) => {
  ...
  const [analyticsPayload, setAnalyticsPayload] = useState(DEFAULT_ANALYTICS_PAYLOAD);
  ...
  return (
      <>
        ...
        <main className="mx-auto max-w-[1960px] p-4">
          <FloatingPopover analyticsEvent={analyticsEvent} analyticsPayload={analyticsPayload} />
          {photoId && (
              <Modal
                  images={images}
                  onClose={() => {
