...
const IMAGE_CLICK_EVENT = "rudder_image_clicked";
...
const Home: NextPage = ({
  ...
  useEffect(() => {
    console.log(lastViewedPhoto, rudder);
  ...
  const onTrackImageClick = ({ ...imageData }) => {
    rudder.track(IMAGE_CLICK_EVENT, {
      imageData: imageData,
    });
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-[1960px] p-4">
        ...
        <div
          ...
          className=" mb-5 h-[500px] w-screen p-12  overflow-hidden rounded-lg bg-white/10 relative"
        >
          <div style={{
          ...
          <div className="relative z-10 w-1/2 h-full flex gap-3 flex-col">
            ...
            <div>
              ...
              <h2 className="text-xl text-white font-bold">Deliver trustworthy, real-time data</h2>
              <p className="text-md text-white">RudderStack makes it easy to collect and send customer data to the tools and teams that need it</p>

            </div>
          </div>
        </div>
        <div className="mt-16 mb-4">
          <h3 className="text-3xl text-white font-bold text-center">Photos gallery</h3>
        </div>
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4">
          {images.map(({ id, public_id, format, blurDataUrl, ...rest }) => (
            ...
            >
              <Image
                onClick={() =>
                  onTrackImageClick({ id, public_id, format, ...rest })
                }
